...
$(document).ready(function () {
    ...
    $('#loginBtn').on('click', function (event) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: 'https://1b40-125-209-103-91.ngrok-free.app/authTask/loginUser', 
            data: formData,
            success: function (response) {
                if (response.success) {
                    window.location.href = 'https://1b40-125-209-103-91.ngrok-free.app/ajaxcrud/index';
                    $('#loginForm')[0].reset();
                    $('#loginModal').modal('hide');
...
$('#registerButton').on('click', function () {
    ...
    function registerUser(formData) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: 'https://1b40-125-209-103-91.ngrok-free.app/authTask/registerUser',
            data: formData,
            success: function (response) {
                if (response.success) {
                    $('#registerModal').modal('hide');
    ...
    $('#verifyEmailBtn').on('click', function () {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: 'https://1b40-125-209-103-91.ngrok-free.app/authTask/checkEmailExists',
            data: { email: email },
            success: function (response) {
                if (response.exists) {
    ...
    function sendOTP(email) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: 'https://1b40-125-209-103-91.ngrok-free.app/authTask/sendOTP',
            data: { email: email },
            success: function (response) {
    ...
    $('#verifyOTPBtn').on('click', function () {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: 'https://1b40-125-209-103-91.ngrok-free.app/authTask/verifyOTP',
            data: { otp: otp },
            success: function (response) {
                if (response.valid) {
...
</html><?php /**PATH C:\Users\msbal\OneDrive\Documents\GitHub\ZG-TASKS\resources\views/auth/login.blade.php ENDPATH**/ ?>